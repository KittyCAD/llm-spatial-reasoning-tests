...
| 23 | Composite perimeter (2-D) | Two 4 cm × 4 cm squares share one corner; interiors don't overlap. Draw the outline and state the total perimeter. | Must visualize L-shape and avoid double-counting edges. | [prompt 23](results/prompt_23.md) | |
| 24 | In-circle radius (2-D) | Right-triangle legs 9 m and 12 m: find the inscribed circle’s radius. | Uses r = (a + b − c)/2 or area / semiperimeter. | [prompt 24](results/prompt_24.md) | |
| 25 | Polygon path & displacement | Robot walks 10 m E, 10 m N, 10 m W, 10 m S. What is net displacement and what closed shape is traced? | Zero displacement; traces a square—checks closure. | [prompt 25](results/prompt_25.md) | |
| 26 | Translation & overlap (2-D) | Rectangle R (−3,−1)→(7,6) shifted (−4,−2) → S. Give S corners and the overlap area of R and S. | Combine vector shift with rectangle intersection math. | [prompt 26](results/prompt_26.md) | |
| 27 | Circumscribed circle (2-D) | Regular hexagon side 5 cm is circumscribed by a circle. Find the circle’s radius and fraction of its area outside the hexagon. | Needs r = s and area ratio πr² to 6·(√3/4)s². | [prompt 27](results/prompt_27.md) | |
